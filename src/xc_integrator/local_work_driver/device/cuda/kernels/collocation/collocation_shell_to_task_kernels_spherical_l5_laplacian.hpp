...
__global__ __launch_bounds__(512,2) void collocation_device_shell_to_task_kernel_spherical_laplacian_5(
  uint32_t                        nshell,
  ...
  for( int itask = global_warp_id; itask < ntasks; itask += nwarp_global ) {
    ...
    for( int ipt = threadIdx.x % cuda::warp_size; ipt < npts; ipt += cuda::warp_size ) {
      ...
      basis_lapl_eval[ipt + 0*npts] = 3*sqrt_14*y*(65*radial_eval_alpha*x*x*x*x - 130*radial_eval_alpha*x*x*y*y + 13*radial_eval_alpha*y*y*y*y + 5*radial_eval_alpha_squared*x*x*x*x*x*x - 5*radial_eval_alpha_squared*x*x*x*x*y*y + 5*radial_eval_alpha_squared*x*x*x*x*z*z - 9*radial_eval_alpha_squared*x*x*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*z*z + radial_eval_alpha_squared*y*y*y*y*y*y + radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_lapl_eval[ipt + 1*npts] = 3*sqrt_35*x*y*z*(13*radial_eval_alpha*x*x - 13*radial_eval_alpha*y*y + radial_eval_alpha_squared*x*x*x*x + radial_eval_alpha_squared*x*x*z*z - radial_eval_alpha_squared*y*y*y*y - radial_eval_alpha_squared*y*y*z*z)/2;
      basis_lapl_eval[ipt + 2*npts] = sqrt_70*y*(-39*radial_eval_alpha*x*x*x*x - 26*radial_eval_alpha*x*x*y*y + 312*radial_eval_alpha*x*x*z*z + 13*radial_eval_alpha*y*y*y*y - 104*radial_eval_alpha*y*y*z*z - 3*radial_eval_alpha_squared*x*x*x*x*x*x - 5*radial_eval_alpha_squared*x*x*x*x*y*y + 21*radial_eval_alpha_squared*x*x*x*x*z*z - radial_eval_alpha_squared*x*x*y*y*y*y + 14*radial_eval_alpha_squared*x*x*y*y*z*z + 24*radial_eval_alpha_squared*x*x*z*z*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 7*radial_eval_alpha_squared*y*y*y*y*z*z - 8*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_lapl_eval[ipt + 3*npts] = sqrt_105*x*y*z*(-13*radial_eval_alpha*x*x - 13*radial_eval_alpha*y*y + 26*radial_eval_alpha*z*z - radial_eval_alpha_squared*x*x*x*x - 2*radial_eval_alpha_squared*x*x*y*y + radial_eval_alpha_squared*x*x*z*z - radial_eval_alpha_squared*y*y*y*y + radial_eval_alpha_squared*y*y*z*z + 2*radial_eval_alpha_squared*z*z*z*z)/2;
      basis_lapl_eval[ipt + 4*npts] = sqrt_15*y*(13*radial_eval_alpha*x*x*x*x + 26*radial_eval_alpha*x*x*y*y - 156*radial_eval_alpha*x*x*z*z + 13*radial_eval_alpha*y*y*y*y - 156*radial_eval_alpha*y*y*z*z + 104*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + 3*radial_eval_alpha_squared*x*x*x*x*y*y - 11*radial_eval_alpha_squared*x*x*x*x*z*z + 3*radial_eval_alpha_squared*x*x*y*y*y*y - 22*radial_eval_alpha_squared*x*x*y*y*z*z - 4*radial_eval_alpha_squared*x*x*z*z*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 11*radial_eval_alpha_squared*y*y*y*y*z*z - 4*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_lapl_eval[ipt + 5*npts] = z*(195*radial_eval_alpha*x*x*x*x + 390*radial_eval_alpha*x*x*y*y - 520*radial_eval_alpha*x*x*z*z + 195*radial_eval_alpha*y*y*y*y - 520*radial_eval_alpha*y*y*z*z + 104*radial_eval_alpha*z*z*z*z + 15*radial_eval_alpha_squared*x*x*x*x*x*x + 45*radial_eval_alpha_squared*x*x*x*x*y*y - 25*radial_eval_alpha_squared*x*x*x*x*z*z + 45*radial_eval_alpha_squared*x*x*y*y*y*y - 50*radial_eval_alpha_squared*x*x*y*y*z*z - 32*radial_eval_alpha_squared*x*x*z*z*z*z + 15*radial_eval_alpha_squared*y*y*y*y*y*y - 25*radial_eval_alpha_squared*y*y*y*y*z*z - 32*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_lapl_eval[ipt + 6*npts] = sqrt_15*x*(13*radial_eval_alpha*x*x*x*x + 26*radial_eval_alpha*x*x*y*y - 156*radial_eval_alpha*x*x*z*z + 13*radial_eval_alpha*y*y*y*y - 156*radial_eval_alpha*y*y*z*z + 104*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + 3*radial_eval_alpha_squared*x*x*x*x*y*y - 11*radial_eval_alpha_squared*x*x*x*x*z*z + 3*radial_eval_alpha_squared*x*x*y*y*y*y - 22*radial_eval_alpha_squared*x*x*y*y*z*z - 4*radial_eval_alpha_squared*x*x*z*z*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 11*radial_eval_alpha_squared*y*y*y*y*z*z - 4*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_lapl_eval[ipt + 7*npts] = sqrt_105*z*(-13*radial_eval_alpha*x*x*x*x + 26*radial_eval_alpha*x*x*z*z + 13*radial_eval_alpha*y*y*y*y - 26*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x - radial_eval_alpha_squared*x*x*x*x*y*y + radial_eval_alpha_squared*x*x*x*x*z*z + radial_eval_alpha_squared*x*x*y*y*y*y + 2*radial_eval_alpha_squared*x*x*z*z*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - radial_eval_alpha_squared*y*y*y*y*z*z - 2*radial_eval_alpha_squared*y*y*z*z*z*z)/4;
      basis_lapl_eval[ipt + 8*npts] = sqrt_70*x*(-13*radial_eval_alpha*x*x*x*x + 26*radial_eval_alpha*x*x*y*y + 104*radial_eval_alpha*x*x*z*z + 39*radial_eval_alpha*y*y*y*y - 312*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x + radial_eval_alpha_squared*x*x*x*x*y*y + 7*radial_eval_alpha_squared*x*x*x*x*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y - 14*radial_eval_alpha_squared*x*x*y*y*z*z + 8*radial_eval_alpha_squared*x*x*z*z*z*z + 3*radial_eval_alpha_squared*y*y*y*y*y*y - 21*radial_eval_alpha_squared*y*y*y*y*z*z - 24*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_lapl_eval[ipt + 9*npts] = 3*sqrt_35*z*(13*radial_eval_alpha*x*x*x*x - 78*radial_eval_alpha*x*x*y*y + 13*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 5*radial_eval_alpha_squared*x*x*x*x*y*y + radial_eval_alpha_squared*x*x*x*x*z*z - 5*radial_eval_alpha_squared*x*x*y*y*y*y - 6*radial_eval_alpha_squared*x*x*y*y*z*z + radial_eval_alpha_squared*y*y*y*y*y*y + radial_eval_alpha_squared*y*y*y*y*z*z)/8;
      basis_lapl_eval[ipt + 10*npts] = 3*sqrt_14*x*(13*radial_eval_alpha*x*x*x*x - 130*radial_eval_alpha*x*x*y*y + 65*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 9*radial_eval_alpha_squared*x*x*x*x*y*y + radial_eval_alpha_squared*x*x*x*x*z*z - 5*radial_eval_alpha_squared*x*x*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y + 5*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
