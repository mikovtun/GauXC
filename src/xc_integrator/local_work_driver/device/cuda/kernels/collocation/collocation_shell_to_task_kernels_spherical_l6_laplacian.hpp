...
__global__ __launch_bounds__(512,2) void collocation_device_shell_to_task_kernel_spherical_laplacian_6(
  uint32_t                        nshell,
  ...
  for( int itask = global_warp_id; itask < ntasks; itask += nwarp_global ) {
    ...
    for( int ipt = threadIdx.x % cuda::warp_size; ipt < npts; ipt += cuda::warp_size ) {
      ...
      basis_lapl_eval[ipt + 0*npts] = sqrt_462*x*y*(42*radial_eval_alpha*x*x*x*x - 140*radial_eval_alpha*x*x*y*y + 42*radial_eval_alpha*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*x*x - 7*radial_eval_alpha_squared*x*x*x*x*y*y - 7*radial_eval_alpha_squared*x*x*y*y*y*y + 3*radial_eval_alpha_squared*y*y*y*y*y*y + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(3*x*x*x*x - 10*x*x*y*y + 3*y*y*y*y))/16;
      basis_lapl_eval[ipt + 1*npts] = 3*sqrt_154*y*z*(75*radial_eval_alpha*x*x*x*x - 150*radial_eval_alpha*x*x*y*y + 15*radial_eval_alpha*y*y*y*y + 5*radial_eval_alpha_squared*x*x*x*x*x*x - 5*radial_eval_alpha_squared*x*x*x*x*y*y + 5*radial_eval_alpha_squared*x*x*x*x*z*z - 9*radial_eval_alpha_squared*x*x*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*z*z + radial_eval_alpha_squared*y*y*y*y*y*y + radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_lapl_eval[ipt + 2*npts] = 3*sqrt_7*x*y*(-15*radial_eval_alpha*x*x*x*x + 150*radial_eval_alpha*x*x*z*z + 15*radial_eval_alpha*y*y*y*y - 150*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x - radial_eval_alpha_squared*x*x*x*x*y*y + 9*radial_eval_alpha_squared*x*x*x*x*z*z + radial_eval_alpha_squared*x*x*y*y*y*y + 10*radial_eval_alpha_squared*x*x*z*z*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 9*radial_eval_alpha_squared*y*y*y*y*z*z - 10*radial_eval_alpha_squared*y*y*z*z*z*z)/4;
      basis_lapl_eval[ipt + 3*npts] = sqrt_210*y*z*(-135*radial_eval_alpha*x*x*x*x - 90*radial_eval_alpha*x*x*y*y + 360*radial_eval_alpha*x*x*z*z + 45*radial_eval_alpha*y*y*y*y - 120*radial_eval_alpha*y*y*z*z - 9*radial_eval_alpha_squared*x*x*x*x*x*x - 15*radial_eval_alpha_squared*x*x*x*x*y*y + 15*radial_eval_alpha_squared*x*x*x*x*z*z - 3*radial_eval_alpha_squared*x*x*y*y*y*y + 10*radial_eval_alpha_squared*x*x*y*y*z*z + 24*radial_eval_alpha_squared*x*x*z*z*z*z + 3*radial_eval_alpha_squared*y*y*y*y*y*y - 5*radial_eval_alpha_squared*y*y*y*y*z*z - 8*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_lapl_eval[ipt + 4*npts] = sqrt_210*x*y*(15*radial_eval_alpha*x*x*x*x + 30*radial_eval_alpha*x*x*y*y - 240*radial_eval_alpha*x*x*z*z + 15*radial_eval_alpha*y*y*y*y - 240*radial_eval_alpha*y*y*z*z + 240*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + 3*radial_eval_alpha_squared*x*x*x*x*y*y - 15*radial_eval_alpha_squared*x*x*x*x*z*z + 3*radial_eval_alpha_squared*x*x*y*y*y*y - 30*radial_eval_alpha_squared*x*x*y*y*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 15*radial_eval_alpha_squared*y*y*y*y*z*z + 16*radial_eval_alpha_squared*z*z*z*z*z*z)/16;
      basis_lapl_eval[ipt + 5*npts] = sqrt_21*y*z*(75*radial_eval_alpha*x*x*x*x + 150*radial_eval_alpha*x*x*y*y - 300*radial_eval_alpha*x*x*z*z + 75*radial_eval_alpha*y*y*y*y - 300*radial_eval_alpha*y*y*z*z + 120*radial_eval_alpha*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*x*x + 15*radial_eval_alpha_squared*x*x*x*x*y*y - 15*radial_eval_alpha_squared*x*x*x*x*z*z + 15*radial_eval_alpha_squared*x*x*y*y*y*y - 30*radial_eval_alpha_squared*x*x*y*y*z*z - 12*radial_eval_alpha_squared*x*x*z*z*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y - 15*radial_eval_alpha_squared*y*y*y*y*z*z - 12*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_lapl_eval[ipt + 6*npts] = -75*radial_eval_alpha*x*x*x*x*x*x/16 - 225*radial_eval_alpha*x*x*x*x*y*y/16 + 675*radial_eval_alpha*x*x*x*x*z*z/8 - 225*radial_eval_alpha*x*x*y*y*y*y/16 + 675*radial_eval_alpha*x*x*y*y*z*z/4 - 225*radial_eval_alpha*x*x*z*z*z*z/2 - 75*radial_eval_alpha*y*y*y*y*y*y/16 + 675*radial_eval_alpha*y*y*y*y*z*z/8 - 225*radial_eval_alpha*y*y*z*z*z*z/2 + 15*radial_eval_alpha*z*z*z*z*z*z - 5*radial_eval_alpha_squared*x*x*x*x*x*x*x*x/16 - 5*radial_eval_alpha_squared*x*x*x*x*x*x*y*y/4 + 85*radial_eval_alpha_squared*x*x*x*x*x*x*z*z/16 - 15*radial_eval_alpha_squared*x*x*x*x*y*y*y*y/8 + 255*radial_eval_alpha_squared*x*x*x*x*y*y*z*z/16 - 15*radial_eval_alpha_squared*x*x*x*x*z*z*z*z/8 - 5*radial_eval_alpha_squared*x*x*y*y*y*y*y*y/4 + 255*radial_eval_alpha_squared*x*x*y*y*y*y*z*z/16 - 15*radial_eval_alpha_squared*x*x*y*y*z*z*z*z/4 - 13*radial_eval_alpha_squared*x*x*z*z*z*z*z*z/2 - 5*radial_eval_alpha_squared*y*y*y*y*y*y*y*y/16 + 85*radial_eval_alpha_squared*y*y*y*y*y*y*z*z/16 - 15*radial_eval_alpha_squared*y*y*y*y*z*z*z*z/8 - 13*radial_eval_alpha_squared*y*y*z*z*z*z*z*z/2 + radial_eval_alpha_squared*z*z*z*z*z*z*z*z;
      basis_lapl_eval[ipt + 7*npts] = sqrt_21*x*z*(75*radial_eval_alpha*x*x*x*x + 150*radial_eval_alpha*x*x*y*y - 300*radial_eval_alpha*x*x*z*z + 75*radial_eval_alpha*y*y*y*y - 300*radial_eval_alpha*y*y*z*z + 120*radial_eval_alpha*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*x*x + 15*radial_eval_alpha_squared*x*x*x*x*y*y - 15*radial_eval_alpha_squared*x*x*x*x*z*z + 15*radial_eval_alpha_squared*x*x*y*y*y*y - 30*radial_eval_alpha_squared*x*x*y*y*z*z - 12*radial_eval_alpha_squared*x*x*z*z*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y - 15*radial_eval_alpha_squared*y*y*y*y*z*z - 12*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_lapl_eval[ipt + 8*npts] = sqrt_210*(15*radial_eval_alpha*x*x*x*x*x*x + 15*radial_eval_alpha*x*x*x*x*y*y - 240*radial_eval_alpha*x*x*x*x*z*z - 15*radial_eval_alpha*x*x*y*y*y*y + 240*radial_eval_alpha*x*x*z*z*z*z - 15*radial_eval_alpha*y*y*y*y*y*y + 240*radial_eval_alpha*y*y*y*y*z*z - 240*radial_eval_alpha*y*y*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x*x*x + 2*radial_eval_alpha_squared*x*x*x*x*x*x*y*y - 15*radial_eval_alpha_squared*x*x*x*x*x*x*z*z - 15*radial_eval_alpha_squared*x*x*x*x*y*y*z*z - 2*radial_eval_alpha_squared*x*x*y*y*y*y*y*y + 15*radial_eval_alpha_squared*x*x*y*y*y*y*z*z + 16*radial_eval_alpha_squared*x*x*z*z*z*z*z*z - radial_eval_alpha_squared*y*y*y*y*y*y*y*y + 15*radial_eval_alpha_squared*y*y*y*y*y*y*z*z - 16*radial_eval_alpha_squared*y*y*z*z*z*z*z*z)/32;
      basis_lapl_eval[ipt + 9*npts] = sqrt_210*x*z*(-45*radial_eval_alpha*x*x*x*x + 90*radial_eval_alpha*x*x*y*y + 120*radial_eval_alpha*x*x*z*z + 135*radial_eval_alpha*y*y*y*y - 360*radial_eval_alpha*y*y*z*z - 3*radial_eval_alpha_squared*x*x*x*x*x*x + 3*radial_eval_alpha_squared*x*x*x*x*y*y + 5*radial_eval_alpha_squared*x*x*x*x*z*z + 15*radial_eval_alpha_squared*x*x*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*z*z + 8*radial_eval_alpha_squared*x*x*z*z*z*z + 9*radial_eval_alpha_squared*y*y*y*y*y*y - 15*radial_eval_alpha_squared*y*y*y*y*z*z - 24*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_lapl_eval[ipt + 10*npts] = 3*sqrt_7*(-15*radial_eval_alpha*x*x*x*x*x*x + 75*radial_eval_alpha*x*x*x*x*y*y + 150*radial_eval_alpha*x*x*x*x*z*z + 75*radial_eval_alpha*x*x*y*y*y*y - 900*radial_eval_alpha*x*x*y*y*z*z - 15*radial_eval_alpha*y*y*y*y*y*y + 150*radial_eval_alpha*y*y*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x*x*x + 4*radial_eval_alpha_squared*x*x*x*x*x*x*y*y + 9*radial_eval_alpha_squared*x*x*x*x*x*x*z*z + 10*radial_eval_alpha_squared*x*x*x*x*y*y*y*y - 45*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + 10*radial_eval_alpha_squared*x*x*x*x*z*z*z*z + 4*radial_eval_alpha_squared*x*x*y*y*y*y*y*y - 45*radial_eval_alpha_squared*x*x*y*y*y*y*z*z - 60*radial_eval_alpha_squared*x*x*y*y*z*z*z*z - radial_eval_alpha_squared*y*y*y*y*y*y*y*y + 9*radial_eval_alpha_squared*y*y*y*y*y*y*z*z + 10*radial_eval_alpha_squared*y*y*y*y*z*z*z*z)/16;
      basis_lapl_eval[ipt + 11*npts] = 3*sqrt_154*x*z*(15*radial_eval_alpha*x*x*x*x - 150*radial_eval_alpha*x*x*y*y + 75*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 9*radial_eval_alpha_squared*x*x*x*x*y*y + radial_eval_alpha_squared*x*x*x*x*z*z - 5*radial_eval_alpha_squared*x*x*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y + 5*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_lapl_eval[ipt + 12*npts] = sqrt_462*(15*radial_eval_alpha*x*x*x*x*x*x - 225*radial_eval_alpha*x*x*x*x*y*y + 225*radial_eval_alpha*x*x*y*y*y*y - 15*radial_eval_alpha*y*y*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x*x*x - 14*radial_eval_alpha_squared*x*x*x*x*x*x*y*y + radial_eval_alpha_squared*x*x*x*x*x*x*z*z - 15*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + 14*radial_eval_alpha_squared*x*x*y*y*y*y*y*y + 15*radial_eval_alpha_squared*x*x*y*y*y*y*z*z - radial_eval_alpha_squared*y*y*y*y*y*y*y*y - radial_eval_alpha_squared*y*y*y*y*y*y*z*z)/32;
