...
__global__ __launch_bounds__(512,2) void collocation_device_shell_to_task_kernel_spherical_hessian_6(
  ...
  for( int itask = global_warp_id; itask < ntasks; itask += nwarp_global ) {
    ...
    for( int ipt = threadIdx.x % cuda::warp_size; ipt < npts; ipt += cuda::warp_size ) {
      ...
      basis_xx_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*x*y*(60*radial_eval*x*x - 60*radial_eval*y*y + 33*radial_eval_alpha*x*x*x*x - 70*radial_eval_alpha*x*x*y*y + 9*radial_eval_alpha*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*x*x - 10*radial_eval_alpha_squared*x*x*x*x*y*y + 3*radial_eval_alpha_squared*x*x*y*y*y*y)/16;
      basis_xx_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*y*z*(20*radial_eval*(3*x*x - y*y) + 40*radial_eval_alpha*x*x*(x*x - y*y) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y))/16;
      basis_xx_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*x*y*(-20*radial_eval*(x*x - 3*z*z) - 2*radial_eval_alpha*(x*x*x*x - 10*x*x*z*z + 4*x*x*(x*x - 5*z*z) - y*y*y*y + 10*y*y*z*z) - (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(x*x*x*x - 10*x*x*z*z - y*y*y*y + 10*y*y*z*z))/4;
      basis_xx_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*y*z*(-12*radial_eval*(9*x*x + y*y - 4*z*z) - 24*radial_eval_alpha*x*x*(3*x*x + y*y - 4*z*z) - (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(9*x*x*x*x + 6*x*x*y*y - 24*x*x*z*z - 3*y*y*y*y + 8*y*y*z*z))/16;
      basis_xx_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*x*y*(4*radial_eval*(5*x*x + 3*y*y - 24*z*z) + 2*radial_eval_alpha*(x*x*x*x + 2*x*x*y*y - 16*x*x*z*z + 4*x*x*(x*x + y*y - 8*z*z) + y*y*y*y - 16*y*y*z*z + 16*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(x*x*x*x + 2*x*x*y*y - 16*x*x*z*z + y*y*y*y - 16*y*y*z*z + 16*z*z*z*z))/16;
      basis_xx_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*y*z*(20*radial_eval*(3*x*x + y*y - 2*z*z) + 40*radial_eval_alpha*x*x*(x*x + y*y - 2*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      ...
      basis_xx_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*x*z*(20*radial_eval*(5*x*x + 3*y*y - 6*z*z) + 2*radial_eval_alpha*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 20*x*x*(x*x + y*y - 2*z*z) + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      basis_xx_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*(2*radial_eval*(15*x*x*x*x + 6*x*x*y*y - 96*x*x*z*z - y*y*y*y + 16*z*z*z*z) + 4*radial_eval_alpha*x*x*(3*x*x*x*x + 2*x*x*y*y - 32*x*x*z*z - y*y*y*y + 16*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(x*x*x*x*x*x + x*x*x*x*y*y - 16*x*x*x*x*z*z - x*x*y*y*y*y + 16*x*x*z*z*z*z - y*y*y*y*y*y + 16*y*y*y*y*z*z - 16*y*y*z*z*z*z))/32;
      basis_xx_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*x*z*(-60*radial_eval*x*x + 36*radial_eval*y*y + 48*radial_eval*z*z - 33*radial_eval_alpha*x*x*x*x + 42*radial_eval_alpha*x*x*y*y + 56*radial_eval_alpha*x*x*z*z + 27*radial_eval_alpha*y*y*y*y - 72*radial_eval_alpha*y*y*z*z - 3*radial_eval_alpha_squared*x*x*x*x*x*x + 6*radial_eval_alpha_squared*x*x*x*x*y*y + 8*radial_eval_alpha_squared*x*x*x*x*z*z + 9*radial_eval_alpha_squared*x*x*y*y*y*y - 24*radial_eval_alpha_squared*x*x*y*y*z*z)/16;
      basis_xx_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*(10*radial_eval*(-3*x*x*x*x + 6*x*x*y*y + 12*x*x*z*z + y*y*y*y - 12*y*y*z*z) + 4*radial_eval_alpha*x*x*(-3*x*x*x*x + 10*x*x*y*y + 20*x*x*z*z + 5*y*y*y*y - 60*y*y*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(-x*x*x*x*x*x + 5*x*x*x*x*y*y + 10*x*x*x*x*z*z + 5*x*x*y*y*y*y - 60*x*x*y*y*z*z - y*y*y*y*y*y + 10*y*y*y*y*z*z))/16;
      basis_xx_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*x*z*(20*radial_eval*x*x - 60*radial_eval*y*y + 11*radial_eval_alpha*x*x*x*x - 70*radial_eval_alpha*x*x*y*y + 15*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 10*radial_eval_alpha_squared*x*x*x*x*y*y + 5*radial_eval_alpha_squared*x*x*y*y*y*y)/16;
      basis_xx_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*(30*radial_eval*(x*x*x*x - 6*x*x*y*y + y*y*y*y) + 12*radial_eval_alpha*x*x*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y) + (radial_eval_alpha + radial_eval_alpha_squared*x*x)*(x*x*x*x*x*x - 15*x*x*x*x*y*y + 15*x*x*y*y*y*y - y*y*y*y*y*y))/32;

      // Evaluate second derivative of bfn wrt xy
      basis_xy_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*(15*radial_eval*x*x*x*x - 90*radial_eval*x*x*y*y + 15*radial_eval*y*y*y*y + 3*radial_eval_alpha*x*x*x*x*x*x - 15*radial_eval_alpha*x*x*x*x*y*y - 15*radial_eval_alpha*x*x*y*y*y*y + 3*radial_eval_alpha*y*y*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*x*x*y*y - 10*radial_eval_alpha_squared*x*x*x*x*y*y*y*y + 3*radial_eval_alpha_squared*x*x*y*y*y*y*y*y)/16;
      basis_xy_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*x*z*(20*radial_eval*x*x - 60*radial_eval*y*y + 5*radial_eval_alpha*x*x*x*x - 10*radial_eval_alpha*x*x*y*y - 15*radial_eval_alpha*y*y*y*y + 5*radial_eval_alpha_squared*x*x*x*x*y*y - 10*radial_eval_alpha_squared*x*x*y*y*y*y + radial_eval_alpha_squared*y*y*y*y*y*y)/16;
      basis_xy_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*(-5*radial_eval*x*x*x*x + 30*radial_eval*x*x*z*z + 5*radial_eval*y*y*y*y - 30*radial_eval*y*y*z*z - radial_eval_alpha*x*x*x*x*x*x - 5*radial_eval_alpha*x*x*x*x*y*y + 10*radial_eval_alpha*x*x*x*x*z*z + 5*radial_eval_alpha*x*x*y*y*y*y + radial_eval_alpha*y*y*y*y*y*y - 10*radial_eval_alpha*y*y*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x*y*y + 10*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + radial_eval_alpha_squared*x*x*y*y*y*y*y*y - 10*radial_eval_alpha_squared*x*x*y*y*y*y*z*z)/4;
      basis_xy_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*x*z*(-36*radial_eval*x*x - 36*radial_eval*y*y + 48*radial_eval*z*z - 9*radial_eval_alpha*x*x*x*x - 54*radial_eval_alpha*x*x*y*y + 24*radial_eval_alpha*x*x*z*z + 3*radial_eval_alpha*y*y*y*y + 24*radial_eval_alpha*y*y*z*z - 9*radial_eval_alpha_squared*x*x*x*x*y*y - 6*radial_eval_alpha_squared*x*x*y*y*y*y + 24*radial_eval_alpha_squared*x*x*y*y*z*z + 3*radial_eval_alpha_squared*y*y*y*y*y*y - 8*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_xy_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*(5*radial_eval*x*x*x*x + 18*radial_eval*x*x*y*y - 48*radial_eval*x*x*z*z + 5*radial_eval*y*y*y*y - 48*radial_eval*y*y*z*z + 16*radial_eval*z*z*z*z + radial_eval_alpha*x*x*x*x*x*x + 11*radial_eval_alpha*x*x*x*x*y*y - 16*radial_eval_alpha*x*x*x*x*z*z + 11*radial_eval_alpha*x*x*y*y*y*y - 96*radial_eval_alpha*x*x*y*y*z*z + 16*radial_eval_alpha*x*x*z*z*z*z + radial_eval_alpha*y*y*y*y*y*y - 16*radial_eval_alpha*y*y*y*y*z*z + 16*radial_eval_alpha*y*y*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x*y*y + 2*radial_eval_alpha_squared*x*x*x*x*y*y*y*y - 16*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + radial_eval_alpha_squared*x*x*y*y*y*y*y*y - 16*radial_eval_alpha_squared*x*x*y*y*y*y*z*z + 16*radial_eval_alpha_squared*x*x*y*y*z*z*z*z)/16;
      basis_xy_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*x*z*(20*radial_eval*x*x + 60*radial_eval*y*y - 40*radial_eval*z*z + 5*radial_eval_alpha*x*x*x*x + 50*radial_eval_alpha*x*x*y*y - 20*radial_eval_alpha*x*x*z*z + 45*radial_eval_alpha*y*y*y*y - 100*radial_eval_alpha*y*y*z*z + 8*radial_eval_alpha*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*y*y + 10*radial_eval_alpha_squared*x*x*y*y*y*y - 20*radial_eval_alpha_squared*x*x*y*y*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y - 20*radial_eval_alpha_squared*y*y*y*y*z*z + 8*radial_eval_alpha_squared*y*y*z*z*z*z)/8;
      ...
      basis_xy_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*y*z*(60*radial_eval*x*x + 20*radial_eval*y*y - 40*radial_eval*z*z + 45*radial_eval_alpha*x*x*x*x + 50*radial_eval_alpha*x*x*y*y - 100*radial_eval_alpha*x*x*z*z + 5*radial_eval_alpha*y*y*y*y - 20*radial_eval_alpha*y*y*z*z + 8*radial_eval_alpha*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*x*x + 10*radial_eval_alpha_squared*x*x*x*x*y*y - 20*radial_eval_alpha_squared*x*x*x*x*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y - 20*radial_eval_alpha_squared*x*x*y*y*z*z + 8*radial_eval_alpha_squared*x*x*z*z*z*z)/8;
      basis_xy_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*x*y*(8*radial_eval*x*x - 8*radial_eval*y*y + 8*radial_eval_alpha*x*x*x*x - 64*radial_eval_alpha*x*x*z*z - 8*radial_eval_alpha*y*y*y*y + 64*radial_eval_alpha*y*y*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + radial_eval_alpha_squared*x*x*x*x*y*y - 16*radial_eval_alpha_squared*x*x*x*x*z*z - radial_eval_alpha_squared*x*x*y*y*y*y + 16*radial_eval_alpha_squared*x*x*z*z*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 16*radial_eval_alpha_squared*y*y*y*y*z*z - 16*radial_eval_alpha_squared*y*y*z*z*z*z)/32;
      basis_xy_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*y*z*(36*radial_eval*x*x + 36*radial_eval*y*y - 48*radial_eval*z*z - 3*radial_eval_alpha*x*x*x*x + 54*radial_eval_alpha*x*x*y*y - 24*radial_eval_alpha*x*x*z*z + 9*radial_eval_alpha*y*y*y*y - 24*radial_eval_alpha*y*y*z*z - 3*radial_eval_alpha_squared*x*x*x*x*x*x + 6*radial_eval_alpha_squared*x*x*x*x*y*y + 8*radial_eval_alpha_squared*x*x*x*x*z*z + 9*radial_eval_alpha_squared*x*x*y*y*y*y - 24*radial_eval_alpha_squared*x*x*y*y*z*z)/16;
      basis_xy_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*x*y*(40*radial_eval*x*x + 40*radial_eval*y*y - 240*radial_eval*z*z + 4*radial_eval_alpha*x*x*x*x + 40*radial_eval_alpha*x*x*y*y - 80*radial_eval_alpha*x*x*z*z + 4*radial_eval_alpha*y*y*y*y - 80*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x + 5*radial_eval_alpha_squared*x*x*x*x*y*y + 10*radial_eval_alpha_squared*x*x*x*x*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y - 60*radial_eval_alpha_squared*x*x*y*y*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 10*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_xy_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*y*z*(-60*radial_eval*x*x + 20*radial_eval*y*y - 15*radial_eval_alpha*x*x*x*x - 10*radial_eval_alpha*x*x*y*y + 5*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 10*radial_eval_alpha_squared*x*x*x*x*y*y + 5*radial_eval_alpha_squared*x*x*y*y*y*y)/16;
      basis_xy_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*x*y*(-120*radial_eval*x*x + 120*radial_eval*y*y - 24*radial_eval_alpha*x*x*x*x + 24*radial_eval_alpha*y*y*y*y + radial_eval_alpha_squared*x*x*x*x*x*x - 15*radial_eval_alpha_squared*x*x*x*x*y*y + 15*radial_eval_alpha_squared*x*x*y*y*y*y - radial_eval_alpha_squared*y*y*y*y*y*y)/32;

      // Evaluate second derivative of bfn wrt xz
      basis_xz_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*y*z*(15*radial_eval_alpha*x*x*x*x - 30*radial_eval_alpha*x*x*y*y + 3*radial_eval_alpha*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*x*x - 10*radial_eval_alpha_squared*x*x*x*x*y*y + 3*radial_eval_alpha_squared*x*x*y*y*y*y)/16;
      basis_xz_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*x*y*(20*radial_eval*(x*x - y*y) + 20*radial_eval_alpha*z*z*(x*x - y*y) + radial_eval_alpha*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y) + radial_eval_alpha_squared*z*z*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y))/16;
      basis_xz_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*y*z*(20*radial_eval*(3*x*x - y*y) + 20*radial_eval_alpha*x*x*(x*x - y*y) - radial_eval_alpha*(x*x*x*x - 10*x*x*z*z + 4*x*x*(x*x - 5*z*z) - y*y*y*y + 10*y*y*z*z) - radial_eval_alpha_squared*x*x*(x*x*x*x - 10*x*x*z*z - y*y*y*y + 10*y*y*z*z))/4;
      basis_xz_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*x*y*(-36*radial_eval*x*x - 12*radial_eval*y*y + 144*radial_eval*z*z - 9*radial_eval_alpha*x*x*x*x - 6*radial_eval_alpha*x*x*y*y + 36*radial_eval_alpha*x*x*z*z + 3*radial_eval_alpha*y*y*y*y - 36*radial_eval_alpha*y*y*z*z + 48*radial_eval_alpha*z*z*z*z - 9*radial_eval_alpha_squared*x*x*x*x*z*z - 6*radial_eval_alpha_squared*x*x*y*y*z*z + 24*radial_eval_alpha_squared*x*x*z*z*z*z + 3*radial_eval_alpha_squared*y*y*y*y*z*z - 8*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_xz_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*y*z*(-96*radial_eval*x*x - 32*radial_eval*y*y + 64*radial_eval*z*z - 27*radial_eval_alpha*x*x*x*x - 26*radial_eval_alpha*x*x*y*y + 16*radial_eval_alpha*x*x*z*z + radial_eval_alpha*y*y*y*y - 16*radial_eval_alpha*y*y*z*z + 16*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + 2*radial_eval_alpha_squared*x*x*x*x*y*y - 16*radial_eval_alpha_squared*x*x*x*x*z*z + radial_eval_alpha_squared*x*x*y*y*y*y - 16*radial_eval_alpha_squared*x*x*y*y*z*z + 16*radial_eval_alpha_squared*x*x*z*z*z*z)/16;
      basis_xz_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*x*y*(20*radial_eval*x*x + 20*radial_eval*y*y - 120*radial_eval*z*z + 5*radial_eval_alpha*x*x*x*x + 10*radial_eval_alpha*x*x*y*y - 40*radial_eval_alpha*x*x*z*z + 5*radial_eval_alpha*y*y*y*y - 40*radial_eval_alpha*y*y*z*z + 5*radial_eval_alpha_squared*x*x*x*x*z*z + 10*radial_eval_alpha_squared*x*x*y*y*z*z - 20*radial_eval_alpha_squared*x*x*z*z*z*z + 5*radial_eval_alpha_squared*y*y*y*y*z*z - 20*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      ...
      basis_xz_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*(25*radial_eval*x*x*x*x + 30*radial_eval*x*x*y*y - 180*radial_eval*x*x*z*z + 5*radial_eval*y*y*y*y - 60*radial_eval*y*y*z*z + 40*radial_eval*z*z*z*z + 5*radial_eval_alpha*x*x*x*x*x*x + 10*radial_eval_alpha*x*x*x*x*y*y - 35*radial_eval_alpha*x*x*x*x*z*z + 5*radial_eval_alpha*x*x*y*y*y*y - 30*radial_eval_alpha*x*x*y*y*z*z - 20*radial_eval_alpha*x*x*z*z*z*z + 5*radial_eval_alpha*y*y*y*y*z*z - 20*radial_eval_alpha*y*y*z*z*z*z + 8*radial_eval_alpha*z*z*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*x*x*z*z + 10*radial_eval_alpha_squared*x*x*x*x*y*y*z*z - 20*radial_eval_alpha_squared*x*x*x*x*z*z*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y*z*z - 20*radial_eval_alpha_squared*x*x*y*y*z*z*z*z + 8*radial_eval_alpha_squared*x*x*z*z*z*z*z*z)/8;
      basis_xz_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*x*z*(-128*radial_eval*x*x + 128*radial_eval*z*z - 26*radial_eval_alpha*x*x*x*x + 4*radial_eval_alpha*x*x*y*y + 30*radial_eval_alpha*y*y*y*y - 64*radial_eval_alpha*y*y*z*z + 32*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + radial_eval_alpha_squared*x*x*x*x*y*y - 16*radial_eval_alpha_squared*x*x*x*x*z*z - radial_eval_alpha_squared*x*x*y*y*y*y + 16*radial_eval_alpha_squared*x*x*z*z*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 16*radial_eval_alpha_squared*y*y*y*y*z*z - 16*radial_eval_alpha_squared*y*y*z*z*z*z)/32;
      basis_xz_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*(-15*radial_eval*x*x*x*x + 18*radial_eval*x*x*y*y + 72*radial_eval*x*x*z*z + 9*radial_eval*y*y*y*y - 72*radial_eval*y*y*z*z - 3*radial_eval_alpha*x*x*x*x*x*x + 6*radial_eval_alpha*x*x*x*x*y*y + 9*radial_eval_alpha*x*x*x*x*z*z + 9*radial_eval_alpha*x*x*y*y*y*y - 54*radial_eval_alpha*x*x*y*y*z*z + 24*radial_eval_alpha*x*x*z*z*z*z + 9*radial_eval_alpha*y*y*y*y*z*z - 24*radial_eval_alpha*y*y*z*z*z*z - 3*radial_eval_alpha_squared*x*x*x*x*x*x*z*z + 6*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + 8*radial_eval_alpha_squared*x*x*x*x*z*z*z*z + 9*radial_eval_alpha_squared*x*x*y*y*y*y*z*z - 24*radial_eval_alpha_squared*x*x*y*y*z*z*z*z)/16;
      basis_xz_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*x*z*(80*radial_eval*x*x - 240*radial_eval*y*y + 14*radial_eval_alpha*x*x*x*x - 100*radial_eval_alpha*x*x*y*y + 40*radial_eval_alpha*x*x*z*z + 30*radial_eval_alpha*y*y*y*y - 120*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x + 5*radial_eval_alpha_squared*x*x*x*x*y*y + 10*radial_eval_alpha_squared*x*x*x*x*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y - 60*radial_eval_alpha_squared*x*x*y*y*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 10*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_xz_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*(radial_eval*(x*x*x*x - 10*x*x*y*y + 4*x*x*(x*x - 5*y*y) + 5*y*y*y*y) + radial_eval_alpha*x*x*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y) + radial_eval_alpha*z*z*(x*x*x*x - 10*x*x*y*y + 4*x*x*(x*x - 5*y*y) + 5*y*y*y*y) + radial_eval_alpha_squared*x*x*z*z*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y))/16;
      basis_xz_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*x*z*(6*radial_eval_alpha*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y) + radial_eval_alpha_squared*(x*x*x*x*x*x - 15*x*x*x*x*y*y + 15*x*x*y*y*y*y - y*y*y*y*y*y))/32;

      // Evaluate second derivative of bfn wrt yy
      basis_yy_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*x*y*(-60*radial_eval*x*x + 60*radial_eval*y*y + 9*radial_eval_alpha*x*x*x*x - 70*radial_eval_alpha*x*x*y*y + 33*radial_eval_alpha*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*y*y - 10*radial_eval_alpha_squared*x*x*y*y*y*y + 3*radial_eval_alpha_squared*y*y*y*y*y*y)/16;
      basis_yy_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*y*z*(-60*radial_eval*x*x + 20*radial_eval*y*y + 15*radial_eval_alpha*x*x*x*x - 70*radial_eval_alpha*x*x*y*y + 11*radial_eval_alpha*y*y*y*y + 5*radial_eval_alpha_squared*x*x*x*x*y*y - 10*radial_eval_alpha_squared*x*x*y*y*y*y + radial_eval_alpha_squared*y*y*y*y*y*y)/16;
      basis_yy_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*x*y*(20*radial_eval*(y*y - 3*z*z) + 2*radial_eval_alpha*(-x*x*x*x + 10*x*x*z*z + y*y*y*y - 10*y*y*z*z + 4*y*y*(y*y - 5*z*z)) - (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(x*x*x*x - 10*x*x*z*z - y*y*y*y + 10*y*y*z*z))/4;
      basis_yy_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*y*z*(-36*radial_eval*x*x + 60*radial_eval*y*y - 48*radial_eval*z*z - 27*radial_eval_alpha*x*x*x*x - 42*radial_eval_alpha*x*x*y*y + 72*radial_eval_alpha*x*x*z*z + 33*radial_eval_alpha*y*y*y*y - 56*radial_eval_alpha*y*y*z*z - 9*radial_eval_alpha_squared*x*x*x*x*y*y - 6*radial_eval_alpha_squared*x*x*y*y*y*y + 24*radial_eval_alpha_squared*x*x*y*y*z*z + 3*radial_eval_alpha_squared*y*y*y*y*y*y - 8*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_yy_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*x*y*(4*radial_eval*(3*x*x + 5*y*y - 24*z*z) + 2*radial_eval_alpha*(x*x*x*x + 2*x*x*y*y - 16*x*x*z*z + y*y*y*y - 16*y*y*z*z + 4*y*y*(x*x + y*y - 8*z*z) + 16*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(x*x*x*x + 2*x*x*y*y - 16*x*x*z*z + y*y*y*y - 16*y*y*z*z + 16*z*z*z*z))/16;
      basis_yy_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*y*z*(20*radial_eval*(3*x*x + 5*y*y - 6*z*z) + 2*radial_eval_alpha*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 20*y*y*(x*x + y*y - 2*z*z) + 8*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      ...
      basis_yy_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*x*z*(20*radial_eval*(x*x + 3*y*y - 2*z*z) + 40*radial_eval_alpha*y*y*(x*x + y*y - 2*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      basis_yy_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*(-2*radial_eval*(-x*x*x*x + 6*x*x*y*y + 15*y*y*y*y - 96*y*y*z*z + 16*z*z*z*z) - 4*radial_eval_alpha*y*y*(-x*x*x*x + 2*x*x*y*y + 3*y*y*y*y - 32*y*y*z*z + 16*z*z*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(x*x*x*x*x*x + x*x*x*x*y*y - 16*x*x*x*x*z*z - x*x*y*y*y*y + 16*x*x*z*z*z*z - y*y*y*y*y*y + 16*y*y*y*y*z*z - 16*y*y*z*z*z*z))/32;
      basis_yy_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*x*z*(12*radial_eval*(x*x + 9*y*y - 4*z*z) + 24*radial_eval_alpha*y*y*(x*x + 3*y*y - 4*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(-3*x*x*x*x + 6*x*x*y*y + 8*x*x*z*z + 9*y*y*y*y - 24*y*y*z*z))/16;
      basis_yy_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*(10*radial_eval*(x*x*x*x + 6*x*x*y*y - 12*x*x*z*z - 3*y*y*y*y + 12*y*y*z*z) + 4*radial_eval_alpha*y*y*(5*x*x*x*x + 10*x*x*y*y - 60*x*x*z*z - 3*y*y*y*y + 20*y*y*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(-x*x*x*x*x*x + 5*x*x*x*x*y*y + 10*x*x*x*x*z*z + 5*x*x*y*y*y*y - 60*x*x*y*y*z*z - y*y*y*y*y*y + 10*y*y*y*y*z*z))/16;
      basis_yy_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*x*z*(-20*radial_eval*(x*x - 3*y*y) - 40*radial_eval_alpha*y*y*(x*x - y*y) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y))/16;
      basis_yy_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*(-30*radial_eval*(x*x*x*x - 6*x*x*y*y + y*y*y*y) - 12*radial_eval_alpha*y*y*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y) + (radial_eval_alpha + radial_eval_alpha_squared*y*y)*(x*x*x*x*x*x - 15*x*x*x*x*y*y + 15*x*x*y*y*y*y - y*y*y*y*y*y))/32;

      // Evaluate second derivative of bfn wrt yz
      basis_yz_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*x*z*(3*radial_eval_alpha*x*x*x*x - 30*radial_eval_alpha*x*x*y*y + 15*radial_eval_alpha*y*y*y*y + 3*radial_eval_alpha_squared*x*x*x*x*y*y - 10*radial_eval_alpha_squared*x*x*y*y*y*y + 3*radial_eval_alpha_squared*y*y*y*y*y*y)/16;
      basis_yz_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*(-radial_eval*(-5*x*x*x*x + 10*x*x*y*y - y*y*y*y + 4*y*y*(5*x*x - y*y)) + radial_eval_alpha*y*y*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y) - radial_eval_alpha*z*z*(-5*x*x*x*x + 10*x*x*y*y - y*y*y*y + 4*y*y*(5*x*x - y*y)) + radial_eval_alpha_squared*y*y*z*z*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y))/16;
      basis_yz_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*x*z*(-20*radial_eval*(-x*x + 3*y*y) + 20*radial_eval_alpha*y*y*(x*x - y*y) + radial_eval_alpha*(-x*x*x*x + 10*x*x*z*z + y*y*y*y - 10*y*y*z*z + 4*y*y*(y*y - 5*z*z)) - radial_eval_alpha_squared*y*y*(x*x*x*x - 10*x*x*z*z - y*y*y*y + 10*y*y*z*z))/4;
      basis_yz_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*(-9*radial_eval*x*x*x*x - 18*radial_eval*x*x*y*y + 72*radial_eval*x*x*z*z + 15*radial_eval*y*y*y*y - 72*radial_eval*y*y*z*z - 9*radial_eval_alpha*x*x*x*x*y*y - 9*radial_eval_alpha*x*x*x*x*z*z - 6*radial_eval_alpha*x*x*y*y*y*y + 54*radial_eval_alpha*x*x*y*y*z*z + 24*radial_eval_alpha*x*x*z*z*z*z + 3*radial_eval_alpha*y*y*y*y*y*y - 9*radial_eval_alpha*y*y*y*y*z*z - 24*radial_eval_alpha*y*y*z*z*z*z - 9*radial_eval_alpha_squared*x*x*x*x*y*y*z*z - 6*radial_eval_alpha_squared*x*x*y*y*y*y*z*z + 24*radial_eval_alpha_squared*x*x*y*y*z*z*z*z + 3*radial_eval_alpha_squared*y*y*y*y*y*y*z*z - 8*radial_eval_alpha_squared*y*y*y*y*z*z*z*z)/16;
      basis_yz_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*x*z*(-32*radial_eval*x*x - 96*radial_eval*y*y + 64*radial_eval*z*z + radial_eval_alpha*x*x*x*x - 26*radial_eval_alpha*x*x*y*y - 16*radial_eval_alpha*x*x*z*z - 27*radial_eval_alpha*y*y*y*y + 16*radial_eval_alpha*y*y*z*z + 16*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*y*y + 2*radial_eval_alpha_squared*x*x*y*y*y*y - 16*radial_eval_alpha_squared*x*x*y*y*z*z + radial_eval_alpha_squared*y*y*y*y*y*y - 16*radial_eval_alpha_squared*y*y*y*y*z*z + 16*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_yz_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*(5*radial_eval*x*x*x*x + 30*radial_eval*x*x*y*y - 60*radial_eval*x*x*z*z + 25*radial_eval*y*y*y*y - 180*radial_eval*y*y*z*z + 40*radial_eval*z*z*z*z + 5*radial_eval_alpha*x*x*x*x*y*y + 5*radial_eval_alpha*x*x*x*x*z*z + 10*radial_eval_alpha*x*x*y*y*y*y - 30*radial_eval_alpha*x*x*y*y*z*z - 20*radial_eval_alpha*x*x*z*z*z*z + 5*radial_eval_alpha*y*y*y*y*y*y - 35*radial_eval_alpha*y*y*y*y*z*z - 20*radial_eval_alpha*y*y*z*z*z*z + 8*radial_eval_alpha*z*z*z*z*z*z + 5*radial_eval_alpha_squared*x*x*x*x*y*y*z*z + 10*radial_eval_alpha_squared*x*x*y*y*y*y*z*z - 20*radial_eval_alpha_squared*x*x*y*y*z*z*z*z + 5*radial_eval_alpha_squared*y*y*y*y*y*y*z*z - 20*radial_eval_alpha_squared*y*y*y*y*z*z*z*z + 8*radial_eval_alpha_squared*y*y*z*z*z*z*z*z)/8;
      ...
      basis_yz_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*x*y*(20*radial_eval*x*x + 20*radial_eval*y*y - 120*radial_eval*z*z + 5*radial_eval_alpha*x*x*x*x + 10*radial_eval_alpha*x*x*y*y - 40*radial_eval_alpha*x*x*z*z + 5*radial_eval_alpha*y*y*y*y - 40*radial_eval_alpha*y*y*z*z + 5*radial_eval_alpha_squared*x*x*x*x*z*z + 10*radial_eval_alpha_squared*x*x*y*y*z*z - 20*radial_eval_alpha_squared*x*x*z*z*z*z + 5*radial_eval_alpha_squared*y*y*y*y*z*z - 20*radial_eval_alpha_squared*y*y*z*z*z*z + 8*radial_eval_alpha_squared*z*z*z*z*z*z)/8;
      basis_yz_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*y*z*(128*radial_eval*y*y - 128*radial_eval*z*z - 30*radial_eval_alpha*x*x*x*x - 4*radial_eval_alpha*x*x*y*y + 64*radial_eval_alpha*x*x*z*z + 26*radial_eval_alpha*y*y*y*y - 32*radial_eval_alpha*z*z*z*z + radial_eval_alpha_squared*x*x*x*x*x*x + radial_eval_alpha_squared*x*x*x*x*y*y - 16*radial_eval_alpha_squared*x*x*x*x*z*z - radial_eval_alpha_squared*x*x*y*y*y*y + 16*radial_eval_alpha_squared*x*x*z*z*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 16*radial_eval_alpha_squared*y*y*y*y*z*z - 16*radial_eval_alpha_squared*y*y*z*z*z*z)/32;
      basis_yz_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*x*y*(12*radial_eval*x*x + 36*radial_eval*y*y - 144*radial_eval*z*z - 3*radial_eval_alpha*x*x*x*x + 6*radial_eval_alpha*x*x*y*y + 36*radial_eval_alpha*x*x*z*z + 9*radial_eval_alpha*y*y*y*y - 36*radial_eval_alpha*y*y*z*z - 48*radial_eval_alpha*z*z*z*z - 3*radial_eval_alpha_squared*x*x*x*x*z*z + 6*radial_eval_alpha_squared*x*x*y*y*z*z + 8*radial_eval_alpha_squared*x*x*z*z*z*z + 9*radial_eval_alpha_squared*y*y*y*y*z*z - 24*radial_eval_alpha_squared*y*y*z*z*z*z)/16;
      basis_yz_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*y*z*(-240*radial_eval*x*x + 80*radial_eval*y*y + 30*radial_eval_alpha*x*x*x*x - 100*radial_eval_alpha*x*x*y*y - 120*radial_eval_alpha*x*x*z*z + 14*radial_eval_alpha*y*y*y*y + 40*radial_eval_alpha*y*y*z*z - radial_eval_alpha_squared*x*x*x*x*x*x + 5*radial_eval_alpha_squared*x*x*x*x*y*y + 10*radial_eval_alpha_squared*x*x*x*x*z*z + 5*radial_eval_alpha_squared*x*x*y*y*y*y - 60*radial_eval_alpha_squared*x*x*y*y*z*z - radial_eval_alpha_squared*y*y*y*y*y*y + 10*radial_eval_alpha_squared*y*y*y*y*z*z)/16;
      basis_yz_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*x*y*(-20*radial_eval*(x*x - y*y) - 20*radial_eval_alpha*z*z*(x*x - y*y) + radial_eval_alpha*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y) + radial_eval_alpha_squared*z*z*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y))/16;
      basis_yz_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*y*z*(-6*radial_eval_alpha*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y) + radial_eval_alpha_squared*(x*x*x*x*x*x - 15*x*x*x*x*y*y + 15*x*x*y*y*y*y - y*y*y*y*y*y))/32;

      // Evaluate second derivative of bfn wrt zz
      basis_zz_eval[ipt + 0*npts] = integrator::cuda::sqrt_462*x*y*(radial_eval_alpha + radial_eval_alpha_squared*z*z)*(3*x*x*x*x - 10*x*x*y*y + 3*y*y*y*y)/16;
      basis_zz_eval[ipt + 1*npts] = 3*integrator::cuda::sqrt_154*y*z*(3*radial_eval_alpha + radial_eval_alpha_squared*z*z)*(5*x*x*x*x - 10*x*x*y*y + y*y*y*y)/16;
      basis_zz_eval[ipt + 2*npts] = 3*integrator::cuda::sqrt_7*x*y*(20*radial_eval*(x*x - y*y) + 40*radial_eval_alpha*z*z*(x*x - y*y) - (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(x*x*x*x - 10*x*x*z*z - y*y*y*y + 10*y*y*z*z))/4;
      basis_zz_eval[ipt + 3*npts] = integrator::cuda::sqrt_210*y*z*(48*radial_eval*(3*x*x - y*y) + 2*radial_eval_alpha*(-9*x*x*x*x - 6*x*x*y*y + 24*x*x*z*z + 3*y*y*y*y - 8*y*y*z*z + 16*z*z*(3*x*x - y*y)) - (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(9*x*x*x*x + 6*x*x*y*y - 24*x*x*z*z - 3*y*y*y*y + 8*y*y*z*z))/16;
      basis_zz_eval[ipt + 4*npts] = integrator::cuda::sqrt_210*x*y*(-32*radial_eval*(x*x + y*y - 6*z*z) - 64*radial_eval_alpha*z*z*(x*x + y*y - 2*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(x*x*x*x + 2*x*x*y*y - 16*x*x*z*z + y*y*y*y - 16*y*y*z*z + 16*z*z*z*z))/16;
      basis_zz_eval[ipt + 5*npts] = integrator::cuda::sqrt_21*y*z*(-40*radial_eval*(3*x*x + 3*y*y - 4*z*z) - 2*radial_eval_alpha*(-5*x*x*x*x - 10*x*x*y*y + 20*x*x*z*z - 5*y*y*y*y + 20*y*y*z*z - 8*z*z*z*z + z*z*(40*x*x + 40*y*y - 32*z*z)) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      ...
      basis_zz_eval[ipt + 7*npts] = integrator::cuda::sqrt_21*x*z*(-40*radial_eval*(3*x*x + 3*y*y - 4*z*z) - 2*radial_eval_alpha*(-5*x*x*x*x - 10*x*x*y*y + 20*x*x*z*z - 5*y*y*y*y + 20*y*y*z*z - 8*z*z*z*z + z*z*(40*x*x + 40*y*y - 32*z*z)) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(5*x*x*x*x + 10*x*x*y*y - 20*x*x*z*z + 5*y*y*y*y - 20*y*y*z*z + 8*z*z*z*z))/8;
      basis_zz_eval[ipt + 8*npts] = integrator::cuda::sqrt_210*(-radial_eval*(x*x*x*x - 6*x*x*z*z - y*y*y*y + 6*y*y*z*z) - 2*radial_eval_alpha*z*z*(x*x*x*x - 2*x*x*z*z - y*y*y*y + 2*y*y*z*z) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(x*x*x*x*x*x + x*x*x*x*y*y - 16*x*x*x*x*z*z - x*x*y*y*y*y + 16*x*x*z*z*z*z - y*y*y*y*y*y + 16*y*y*y*y*z*z - 16*y*y*z*z*z*z)/32);
      basis_zz_eval[ipt + 9*npts] = integrator::cuda::sqrt_210*x*z*(48*radial_eval*(x*x - 3*y*y) + 2*radial_eval_alpha*(-3*x*x*x*x + 6*x*x*y*y + 8*x*x*z*z + 9*y*y*y*y - 24*y*y*z*z + 16*z*z*(x*x - 3*y*y)) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(-3*x*x*x*x + 6*x*x*y*y + 8*x*x*z*z + 9*y*y*y*y - 24*y*y*z*z))/16;
      basis_zz_eval[ipt + 10*npts] = 3*integrator::cuda::sqrt_7*(20*radial_eval*(x*x*x*x - 6*x*x*y*y + y*y*y*y) + 40*radial_eval_alpha*z*z*(x*x*x*x - 6*x*x*y*y + y*y*y*y) + (radial_eval_alpha + radial_eval_alpha_squared*z*z)*(-x*x*x*x*x*x + 5*x*x*x*x*y*y + 10*x*x*x*x*z*z + 5*x*x*y*y*y*y - 60*x*x*y*y*z*z - y*y*y*y*y*y + 10*y*y*y*y*z*z))/16;
      basis_zz_eval[ipt + 11*npts] = 3*integrator::cuda::sqrt_154*x*z*(3*radial_eval_alpha + radial_eval_alpha_squared*z*z)*(x*x*x*x - 10*x*x*y*y + 5*y*y*y*y)/16;
      basis_zz_eval[ipt + 12*npts] = integrator::cuda::sqrt_462*(radial_eval_alpha + radial_eval_alpha_squared*z*z)*(x*x*x*x*x*x - 15*x*x*x*x*y*y + 15*x*x*y*y*y*y - y*y*y*y*y*y)/32;
